...
@Component({
  selector: 'app-superadminpush',
  templateUrl: './superadminpush.component.html',
  styleUrls: ['./superadminpush.component.css']
})
export class SuperadminpushComponent implements OnInit {
  ...
  getRequestedDetails(): void {
    ...
    this.commonService.getSuperPushRequestedDetails()
